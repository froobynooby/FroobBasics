...
public class TpaCommand extends PlayerCommandExecutor {
    private TeleportManager teleportManager;
    private PlayerManager playerManager;

    public TpaCommand(TeleportManager teleportManager, PlayerManager playerManager) {
    ...
    public boolean onPlayerCommandProcess(Player player, Command command, String cl, String[] args) {
        ...
        teleportManager.requestTeleport("to", player, receiver, playerManager);
        return true;
    }
